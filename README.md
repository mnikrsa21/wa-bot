...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mnikrsa21/wa-bot)
...
git clone https://github.com/mnikrsa21/wa-bot
cd wa-bot
npm install
npm update
```
